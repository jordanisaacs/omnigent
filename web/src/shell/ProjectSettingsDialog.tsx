...
// folders, agent, and whether new sessions start in a fresh git worktree.
// Model / reasoning-effort / harness are per-agent run config, and the worktree
// BASE branch is a global preference (Settings › Git) — both deliberately out
// of scope here. The host and agent pickers reuse the composer's components;
// directory fields reuse its filesystem browser inside the modal.
